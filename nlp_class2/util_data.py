...
def get_wikipedia_data(n_files, n_vocab, by_paragraph=False):
    ...
    input_files = [f for f in os.listdir(prefix) if f.startswith('itwiki') and f.endswith('txt')]
    ...
    assert('re' in word2idx_small)
    assert('regina' in word2idx_small)
    assert('uomo' in word2idx_small)
    assert('donna' in word2idx_small)
